...
function loader(){
    ...
    for (i=0;i<groceries.length;i++) {
        buildList = buildList + "<li><div class='row justify-content-between'><p class='col-3'>"+groceries[i]+"</p><button class='closer verticals buttons col-1 ps-2' id="+i+" onclick='removeItem(this.id)'>x</button></div></li>";
    }
